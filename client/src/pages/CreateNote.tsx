...
const CreateNote = () => {
  ...
  const onSubmit = async (
    ...
    try {
      ...
      const link =
        `${window.location.origin}/note/${token}`;
      ...
      <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-3xl flex-col px-4 py-10 sm:px-6 lg:py-16">
        ...
        <header className="mb-10 text-center">
          ...
          <div className="mb-5 flex justify-center">
            ...
            <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-white/10 bg-white/[0.05] shadow-2xl">
          ...
          <p className="mx-auto mt-3 max-w-md text-sm leading-6 text-zinc-400 sm:text-base">
            Create a secret link that
            disappears after it is revealed.
          </p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <CardDescription className="mt-1 text-zinc-500">
                  Your secret is encrypted before
                  being stored.
                </CardDescription>
              ...
              <div className="rounded-lg border border-white/[0.06] bg-white/[0.02] px-4 py-3">
                ...
                <div className="flex gap-3">
                  ...
                  <p className="text-xs leading-5 text-zinc-500">
                    Your secret is encrypted before
                    storage and permanently destroyed
                    when revealed.
                  </p>
